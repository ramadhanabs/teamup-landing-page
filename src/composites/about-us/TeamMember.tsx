...
const TeamMember = () => {
  ...
  return (
    <div>
      {/* Team Geng */}
      <div className="grid grid-cols-12 gap-10 mb-[100px]">
      ...
      <div className="grid grid-cols-12 gap-10 mb-[100px]">
        ...
        <div className="col-span-9">
          <div className="grid grid-cols-2">
            {PARTNER.map(item => (
              <div
                className="flex items-end py-10 gap-10 border-b border-grey-light"
                key={item.id}
              >
                <Image
            ...
            <div className="flex items-end py-10 gap-10 border-b border-grey-light">
              <Button
                variant="circle"
